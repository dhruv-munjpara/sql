...
def data_update():
    try:
        ...
        name=input("enter u r name for upadte")
        email=input("enter u r email for update")
        age=input("enter u r age for update")


        sql="update student set name=%s,email=%s,age=%s where id=%s"
        val=(name,email,age,id)
